...
data modify block ~ ~1 ~ Items append value {Slot:0b,id:"minecraft:stone",Count:1b}
data modify block ~ ~1 ~ Items[0].id set from storage nt:tmp tmp.items[0].item.id
data modify block ~ ~1 ~ Items[0].tag set from storage nt:tmp tmp.items[0].item.tag
