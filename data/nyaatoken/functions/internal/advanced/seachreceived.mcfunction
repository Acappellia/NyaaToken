...
execute if score #tmploop2 nt_core matches 1 store success score #tmploop nt_core run data modify storage nyaatoken:reward tmpreceived[0].uuid set from entity @s UUID
