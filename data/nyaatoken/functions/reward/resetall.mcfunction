...
tellraw @p[distance=..10] [{"text":"[NyaaToken] ","color":"dark_green"},{"text":"已关闭奖励发放","color":"light_gray"}]
...
tellraw @p[distance=..10] [{"text":"[NyaaToken] ","color":"dark_green"},{"text":"已重置本轮奖励配置与发放记录","color":"light_gray"}]
